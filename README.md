...
3. **Hit SNAP BALL** to run the play — the WR animates along your route

### The Drive

The game simulates an NFL drive with **3 plays** and up to **4 downs** per play:

| Play | Type | Objective |
|------|------|-----------|
| 1 | Short Rush | Quick gain — move the chains |
| 2 | Screen Pass | Mid-range — get into the red zone |
| 3 | Deep Ball | Touchdown — reach the end zone |

- **Success** (route reaches the target): Advance to the next play with a fresh set of downs
- **Failure** (incomplete route or sacked by a defender): Down increments, try again
- **4th down failure**: Turnover on downs — drive over
...
- Each puzzle has a **limited inventory** of route pieces — shown as count badges on each piece
